...
function createXHR() { // XMLHttpRequest객체를 생성하는 메소드
	if(window.ActiveXObject) { // 웹 브라우저가 IE5.0, IE6.0인 경우 XMLHttpRequest객체 생성
		xhrObject = new ActiveXObject("Microsoft.XMLHTTP");
	}else if(window.XMLHttpRequest) { // 웹 브라우저가 IE7.0이상, 크롬, 파이어폭스, 사파리, 오페라등의 경우 XMLHttpRequest객체 생성
